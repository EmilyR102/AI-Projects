...
class InferenceModule:
    ...
    def getObservationProb(self, noisyDistance, pacmanPosition, ghostPosition, jailPosition):
        ...
        """
        "*** BEGIN YOUR CODE HERE ***"
        # when ghost is captured (gpos = jailpos), sensor = NONE, prob = 1 for ghost is in jail, outside (prob = 0)
        # if sensor != NONE, ghost NOT in jail prob = 1,(inside = prob = 0)
...
class ExactInference(InferenceModule):
    ...
    def elapseTime(self, gameState):
        ...
        for newPos in allPos:
            for oldPos in allPos:
                #transition probability distribution from oldPos
...
class ParticleFilter(InferenceModule):
    ...
    def initializeUniformly(self, gameState):
        ...
        self.particles = []
        "*** BEGIN YOUR CODE HERE ***"
        particlesPerPosition = round(self.numParticles/len(self.legalPositions))
